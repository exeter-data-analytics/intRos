...
#| echo: false
#| fig-align: left
#| fig-cap: Example what your folders might look like inside your Project folder (adapted from Martin Chan's [beginners guide to using R Studio projects](https://martinctc.github.io/blog/rstudio-projects-and-working-directories-a-beginner's-guide/))
library(tidyverse)
library(magick)
